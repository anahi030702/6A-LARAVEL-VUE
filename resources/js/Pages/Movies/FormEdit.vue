    ...
    <MoviesLayout>
        ...
        <div class="row mb-2">
            ...
            <div class="col-6">
                ...
                <input type="text" class="form-control" v-model="form.title" required minlength="2" maxlength="50">
        ...
        <div class="row mb-2">
            ...
            <div class="col-6">
                <input type="text" class="form-control" v-model="form.director" required minlength="3" maxlength="50">
        ...
        <div class="row mb-2">
            ...
            <div class="col-6">
                <input type="text" class="form-control" id="duration" placeholder="150" v-model="form.duration" required minlength="3" maxlength="250" pattern="^\d+$">
