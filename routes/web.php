...
Route::get('/inicio', [PersonaController::class, 'index']);
Route::get('/personas/formcreate', [PersonaController::class, 'formcreate']);
Route::post('/personas/create', [PersonaController::class, 'create']);
Route::delete('personas/borrar/{id}', [PersonaController::class, 'delete']);
Route::get('/personas/formedit/{id}', [PersonaController::class, 'viewupdate']);
Route::put('/personas/update', [PersonaController::class, 'update']);
